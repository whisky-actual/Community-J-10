...
JF_17 = {
    ...
    -----------------------------------------------------------------------
    tand_gear_max                            = 0.754, --2.1445, -- tangent on maximum yaw angle of front wheel, 65 degrees tan(64deg)
    ...
    nose_gear_amortizer_reversal_stroke      = -0.174,                -- up
    nose_gear_amortizer_normal_weight_stroke = -0.065,                -- down from nose_gear_pos
    ...
    main_gear_pos                            = {-0.423,  -2.01, -1.387},    -- main gear coords==后轮
    main_gear_wheel_diameter                 = 0.972,            -- in m
    main_gear_amortizer_direct_stroke        = 0,        -- down from main_gear_pos !!!
    main_gear_amortizer_reversal_stroke      = -0.09,     -- up
