...
--	Boards
	...
	{"J-10-16-y"		,DIFFUSE	,	"empty", true};

--	Fuselage
	{"J-10-01-A"		,DIFFUSE	,	"PLAAF_GC_j-10-01-a", true};
	{"J-10-01-A"		,SPECULAR	,	"PLAAF_GC_j-10-01-a_spc", true};

--	Wings	
	{"J-10-02-A"		,DIFFUSE	,	"PLAAF_GC_j-10-02-a", true};
	{"J-10-02-A"		,SPECULAR	,	"PLAAF_GC_j-10-02-a_spc", true};
	{"J-10-pylons"		,DIFFUSE	,	"J-10-pylons", true};
	{"J-10-pylons"		,SPECULAR	,	"j-10-pylons_spc", true};

--	Gears and Doors
	{"J-10-09"			,DIFFUSE	,	"J-10-09", true};
	{"J-10-09"			,SPECULAR	,	"j-10-09_spc", true};
	{"J-10-06"			,DIFFUSE	,	"J-10-06", true};
