...
dofile(current_mod_path .. '/Entries/Loadouts/mils_pl10.lua')
dofile(current_mod_path .. '/Entries/Loadouts/mils_pl12.lua')
dofile(current_mod_path .. '/Entries/Loadouts/mils_pl15.lua')
