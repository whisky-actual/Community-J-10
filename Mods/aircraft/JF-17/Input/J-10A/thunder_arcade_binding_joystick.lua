...
{ pressed = iCommandPlane_Helmet_Brightess_Up  , name = _('Goggle Gain - Inc'), category = _('Sensors')},
{ pressed = iCommandPlane_Helmet_Brightess_Down, name = _('Goggle Gain - Dec'), category = _('Sensors')},

-- 光电传感器专用按键
{ down = key_cmds.Laser_OnOff,              name = _('Laser Designator On/Off'),    category = _('Sensors')},
{ pressed = key_cmds.Sensor_ZoomIn,         name = _('FOV Increase'),               category = _('Sensors')},
{ pressed = key_cmds.Sensor_ZoomOut,        name = _('FOV Decrease'),               category = _('Sensors')},

{ pressed = key_cmds.Sensor_Antenna_Up,     name = _(cmd_names.Sensor_Up),    category = {_('Sensors'), _('HOTAS')}},
{ pressed = key_cmds.Sensor_Antenna_Down,   name = _(cmd_names.Sensor_Down),  category = {_('Sensors'), _('HOTAS')}},
{ pressed = key_cmds.Sensor_Antenna_Left,   name = _(cmd_names.Sensor_Left),  category = {_('Sensors')}},
{ pressed = key_cmds.Sensor_Antenna_Right,  name = _(cmd_names.Sensor_Right), category = {_('Sensors')}},
...
-- FCS
{ down = key_cmds.FLAP, name = _('Flaps Up/Down'), cockpit_device_id = devices.FCS, category = _('Systems')},
{ down = key_cmds.FLAP_DN, name = _('Flaps Down'), cockpit_device_id = devices.FCS, category = _('Systems')},
{ down = key_cmds.FLAP_UP, name = _('Flaps Up'), cockpit_device_id = devices.FCS, category = _('Systems')},
{ down = key_cmds.Gear, name = _('Landing Gear Up/Down'), cockpit_device_id = devices.GEAR, category = _('Systems')},
{ down = key_cmds.GearUp, name = _('Landing Gear Up'), cockpit_device_id = devices.GEAR, category = _('Systems')},
{ down = key_cmds.GearDown, name = _('Landing Gear Down'), cockpit_device_id = devices.GEAR, category = _('Systems')},
...
{ down = key_cmds.FCS_AG1_AG2_Toggle, name = _(cmd_names.PNT_535.." - Toggle"), cockpit_device_id = devices.FCS, category = {_(category_device_special),_('FCS')}},

--{combos = {{key = 'C', reformers = {'LCtrl'}}}, down = key_cmds.Canopy, name = _('Canopy Open/Close'), category = _('Systems')},
{ down = key_cmds.Chute, name = _('Dragging Chute'), cockpit_device_id = devices.FCS, category = _('Systems')},

{ down = key_cmds.WheelBrakeD, up = key_cmds.WheelBrakeU, name = _('Wheel Brake On'), category = _('Systems')},
...
{ pressed = key_cmds.THROTTLE_UP, name = _('Throttle Up'),   category = _('Flight Control')},
{ pressed = key_cmds.THROTTLE_DN, name = _('Throttle Down'), category = _('Flight Control')},

-- Flight Control
{ down = key_cmds.PitchDownStart, up = key_cmds.PitchDownEnd, name = _('Aircraft Pitch Down'), category = _('Flight Control')},
{ down = key_cmds.PitchUpStart, up = key_cmds.PitchUpEnd, name = _('Aircraft Pitch Up'), category = _('Flight Control')},
{ down = key_cmds.RollLeftStart, up = key_cmds.RollLeftEnd, name = _('Aircraft Bank Left'), category = _('Flight Control')},
{ down = key_cmds.RollRightStart, up = key_cmds.RollRightEnd, name = _('Aircraft Bank Right'), category = _('Flight Control')},
{ down = key_cmds.YawLeftStart, up = key_cmds.YawLeftEnd, name = _('Aircraft Rudder Left'), category = _('Flight Control')},
{ down = key_cmds.YawRightStart, up = key_cmds.YawRightEnd, name = _('Aircraft Rudder Right'), category = _('Flight Control')},
...
-- Nav
{ down = key_cmds.Nav_Wpt_Next, name = _('Next Waypoint'), category = _('Navigation')},
{ down = key_cmds.Nav_Wpt_Prev, name = _('Prev Waypoint'), category = _('Navigation')},

-- Weapon
{ down = key_cmds.Gun_OnOff,       name = _('Gun Mode On/Off'), category = _('Weapons')},
