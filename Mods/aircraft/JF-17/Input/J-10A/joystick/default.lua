...
-- T3: air brake
{   down = key_cmds.AirBrake,    name = _(cmd_names.AirBrake),     cockpit_device_id = devices.FCS, category = _('HOTAS')},
{pressed = key_cmds.AirBrakeOn,  name = _(cmd_names.AirBrakeOn),   cockpit_device_id = devices.FCS, category = _('HOTAS')},
{pressed = key_cmds.AirBrakeOff, name = _(cmd_names.AirBrakeOff),  cockpit_device_id = devices.FCS, category = _('HOTAS')},
