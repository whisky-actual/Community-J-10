...
JF_17 = {
    ...
    -------------------------
    M_empty						=	5090,	-- kg  with pilot and nose load, JAS 39C = 6800 (6586.0-886.35))
	M_nominal					=	5090+2325,	-- kg (Empty Plus Full Internal F) 9430 (8936.0-886.35)
    M_max						=	5190+2325+6600,	-- kg (Maximum Take Off Weight)
...
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
                
--              === BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 }, -- AIM-120C-7 x1
                --{ CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0},arg = 308, arg_value = 1.0,}, -- AIM-120C-7 x2
                --{ CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0},arg = 308, arg_value = 1.0,}, -- AIM-120C-7 x3
							
--				==== SMOKE PODS ===
                { CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E741}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E742}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E743}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E744}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E745}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E746}", attach_point_position = {0.0, 0.0, 0.0}, arg = 308, arg_value = 1.0 },
            }
        ),
		...
		pylon(2, 1, 0, 0, 0,
            ...
            {
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 309, arg_value = 1.0 },

--				=== BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- AIM-120C-7 x1
                { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, connector = "point309", arg_value = -1.0 }, -- AIM-120C-7 x2
--              { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, connector = "point309", arg_value = -1.0 }, -- AIM-120C-7 x3
				
--				=== AIR TO GROUND MISSILES ===
                { CLSID = "DIS_C-701T",       attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- AGM-65K TV
				{ CLSID = "DIS_C-701IR",      attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- AGM-65G IR
                { CLSID = "DIS_CM-400AKG",    attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- TESTING!
                { CLSID = "DIS_C-802AK",      attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- Rb15F Mk4 Antiship missiles
                { CLSID = 'DIS_CM-802AKG',    attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 },	--KEPD 350 
                { CLSID = "DIS_LD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- MAR-1 Anti radiation missiles x1
--              { CLSID = "DIS_LD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0},  connector = "point309", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x1
                { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, connector = "point309", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x2	
        
					
--			    === GUIDED BOMBS ===
                { CLSID = "DIS_GBU_10", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-10

				{ CLSID = "DIS_GBU_12", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-12
				{ CLSID = "DIS_GBU_12_DUAL",attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-12 x 2
                { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-12 x2
--              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-12 x3
                
                { CLSID = "DIS_GBU_16", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- GBU-16
				               
                { CLSID = "DIS_GB6",     attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },-- AGM154-A
                { CLSID = "DIS_GB6_HE",  attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- AGM154-B
                { CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },-- AGM154-C		

                { CLSID = "DIS_LS_6_100",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- GBU-31 BLU-109
                { CLSID = "DIS_LS_6_100_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- WIP
--              { CLSID = "DIS_LS_6_100_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_250",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- GBU-39 SDBx2
 				{ CLSID = "DIS_LS_6_250_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- GBU-39 SDBx4
--              { CLSID = "DIS_LS_6_250_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_500", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- DWS39/BK90	
								
--				=== UNGUIDED BOMBS ===
				{ CLSID = "DIS_MK_20",                 attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-20 Rockeye (can we make this the M71 LD)
                { CLSID = "DIS_MK_20_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19
--              { CLSID = "DIS_MK_20_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19

                { CLSID = "{Mk82SNAKEYE}",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82S
                { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19
--              { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19

                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82
                --{ CLSID = "{BRU33_2X_MK-82}",                     attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82 x 2
                { CLSID = "DIS_MK_82_DUAL_GDJ_II19_L",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19
--              { CLSID = "DIS_MK_82_DUAL_GDJ_II19_R",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19

                { CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Mk-83
				
				{ CLSID = "DIS_TYPE200",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- SB M71
				{ CLSID = "DIS_TYPE200_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- SB M71
--				{ CLSID = "DIS_TYPE200_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- SB M71

--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90",                   attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- Brimstone x3
                { CLSID = "DIS_RKT_90_UG",                 attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 }, -- M70B AP
                { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
--              { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
				
--				=== OTHERS ===   
                { CLSID = "DIS_WMD7",      attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },
                { CLSID = "DIS_SPJ_POD",   attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5  },
                { CLSID = "DIS_AKG_DLPOD", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },

--              { CLSID = "DIS_TANK800",        attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5 }, 
--              { CLSID = "DIS_TANK1100",       attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5 },
--              { CLSID = "DIS_TANK800_EMPTY",  attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5 },
--              { CLSID = "DIS_TANK1100_EMPTY", attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5 },

                { CLSID = 'DIS_SMOKE_GENERATOR_R', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_G', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_B', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_W', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_Y', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_O', attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = 0.5 },

--				=== Remove pylon ===		
				{ CLSID = "<CLEAN>", attach_point_position = {0.0, 0.0, 0.0}, connector = "point309", arg_value = -1.0 },
            }
        ),
        pylon(3, 1, 0, 0, 0,
            {
            ...
            {
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },

--				=== BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- AIM-120C-7 x1
                { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 310, connector = "PYLON_31", arg_value = -1.0 }, -- AIM-120C-7 x2
--              { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 310, connector = "PYLON_31", arg_value = -1.0 }, -- AIM-120C-7 x3
				
--				=== AIR TO GROUND MISSILES ===
                { CLSID = "DIS_C-701T",       attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- AGM-65K TV
				{ CLSID = "DIS_C-701IR",      attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- AGM-65G IR
                { CLSID = "DIS_CM-400AKG",    attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- TESTING!
                { CLSID = "DIS_C-802AK",      attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- Rb15F Mk4 Antiship missiles
                { CLSID = 'DIS_CM-802AKG',    attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 },	--KEPD 350 
                { CLSID = "DIS_LD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30", arg_value = 1.0 }, -- MAR-1 Anti radiation missiles x1
--              { CLSID = "DIS_LD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 310, connector = "PYLON_31",arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x1
                { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 310, connector = "PYLON_31",arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x2	
        
					
--			    === GUIDED BOMBS ===
                { CLSID = "DIS_GBU_10", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-10

				{ CLSID = "DIS_GBU_12", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-12
				{ CLSID = "DIS_GBU_12_DUAL",attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-12 x 2
                { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-12 x2
--              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-12 x3
                
                { CLSID = "DIS_GBU_16", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- GBU-16
				               
                { CLSID = "DIS_GB6",     attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 },-- AGM154-A
                { CLSID = "DIS_GB6_HE",  attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- AGM154-B
                { CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 },-- AGM154-C		

                { CLSID = "DIS_LS_6_100",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- GBU-31 BLU-109
                { CLSID = "DIS_LS_6_100_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- WIP
--              { CLSID = "DIS_LS_6_100_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_250",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- GBU-39 SDBx2
 				{ CLSID = "DIS_LS_6_250_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- GBU-39 SDBx4
--              { CLSID = "DIS_LS_6_250_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_500", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- DWS39/BK90	
								
--				=== UNGUIDED BOMBS ===
				{ CLSID = "DIS_MK_20",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-20 Rockeye (can we make this the M71 LD)
                { CLSID = "DIS_MK_20_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19
--              { CLSID = "DIS_MK_20_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19

                { CLSID = "{Mk82SNAKEYE}",              attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82S
                { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19
--              { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19

                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82
                --{ CLSID = "{BRU33_2X_MK-82}",                     attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82 x 2
                { CLSID = "DIS_MK_82_DUAL_GDJ_II19_L",              attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19
--              { CLSID = "DIS_MK_82_DUAL_GDJ_II19_R",              attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19

                { CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Mk-83
				
				{ CLSID = "DIS_TYPE200",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- SB M71
				{ CLSID = "DIS_TYPE200_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- SB M71
--				{ CLSID = "DIS_TYPE200_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- SB M71

--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90",                   attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- Brimstone x3
                { CLSID = "DIS_RKT_90_UG",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 }, -- M70B AP
                { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 },
--              { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 },
				
--				=== OTHERS ===   
                { CLSID = "DIS_WMD7",      attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },
                { CLSID = "DIS_SPJ_POD",   attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5  },
                { CLSID = "DIS_AKG_DLPOD", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31", arg_value = 0.5 },

                { CLSID = "DIS_TANK800",        attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31",arg_value = 0.5 }, 
                { CLSID = "DIS_TANK1100",       attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31",arg_value = 0.5 },
                { CLSID = "DIS_TANK800_EMPTY",  attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31",arg_value = 0.5 },
                { CLSID = "DIS_TANK1100_EMPTY", attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_31",arg_value = 0.5 },

                { CLSID = 'DIS_SMOKE_GENERATOR_R', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_G', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_B', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_W', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_Y', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_O', attach_point_position = {0.0, 0.0, 0.0}, arg = 310, connector = "PYLON_30",arg_value = 1.0 },

--				=== Remove pylon ===		
				{ CLSID = "<CLEAN>", attach_point_position = {0.0, 0.0, 0.0}, connector = "PYLON_30", arg_value = -1.0 },
        ...
        pylon(4, 1, 0, 0, 0,
            ...
            {	
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},

--				=== BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- AIM-120C-7 x1
                { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- AIM-120C-7 x2
                { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- AIM-120C-7 x3
				
--				=== AIR TO GROUND MISSILES ===
                { CLSID = "DIS_C-701T",       attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- AGM-65K TV
				{ CLSID = "DIS_C-701IR",      attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- AGM-65G IR
                { CLSID = "DIS_CM-400AKG",    attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- TESTING!
                { CLSID = "DIS_C-802AK",      attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- Rb15F Mk4 Antiship missiles
                { CLSID = 'DIS_CM-802AKG',    attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 },	--KEPD 350 
                { CLSID = "DIS_LD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- MAR-1 Anti radiation missiles x1
                --{ CLSID = "DIS_LD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9 }, -- MAR-1 Anti radiation missiles x1
                { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- MAR-1 Anti radiation missiles x2	
        
					
--			    === GUIDED BOMBS ===
                { CLSID = "DIS_GBU_10", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-10

				{ CLSID = "DIS_GBU_12", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-12
				{ CLSID = "DIS_GBU_12_DUAL",attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-12 x 2
                { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-12 x2
--              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-12 x3
                
                { CLSID = "DIS_GBU_16", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- GBU-16
				               
                { CLSID = "DIS_GB6",     attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  },-- AGM154-A
                { CLSID = "DIS_GB6_HE",  attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- AGM154-B
                { CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  },-- AGM154-C		

                { CLSID = "DIS_LS_6_100",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- GBU-31 BLU-109
                { CLSID = "DIS_LS_6_100_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- WIP
--              { CLSID = "DIS_LS_6_100_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- WIP

                { CLSID = "DIS_LS_6_250",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- GBU-39 SDBx2
 				{ CLSID = "DIS_LS_6_250_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- GBU-39 SDBx4
--              { CLSID = "DIS_LS_6_250_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },-- WIP

                { CLSID = "DIS_LS_6_500", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- DWS39/BK90	
								
--				=== UNGUIDED BOMBS ===
				{ CLSID = "DIS_MK_20",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-20 Rockeye (can we make this the M71 LD)
                { CLSID = "DIS_MK_20_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-20 Rockeye x2 gjd-ii19
--              { CLSID = "DIS_MK_20_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-20 Rockeye x2 gjd-ii19

                { CLSID = "{Mk82SNAKEYE}",              attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82S
                { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82 Snakeye x2 gjd-ii19
--              { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82 Snakeye x2 gjd-ii19

                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82
                --{ CLSID = "{BRU33_2X_MK-82}",                     attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82 x 2
                { CLSID = "DIS_MK_82_DUAL_GDJ_II19_L",              attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82 x2 gjd-ii19
--              { CLSID = "DIS_MK_82_DUAL_GDJ_II19_R",              attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-82 x2 gjd-ii19

                { CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Mk-83
				
				{ CLSID = "DIS_TYPE200",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- SB M71
				{ CLSID = "DIS_TYPE200_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- SB M71
--				{ CLSID = "DIS_TYPE200_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- SB M71

--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90",                   attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- Brimstone x3
                { CLSID = "DIS_RKT_90_UG",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  }, -- M70B AP
                { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  },
--              { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  },
				
--				=== OTHERS ===   
                { CLSID = "DIS_WMD7",      attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },
                { CLSID = "DIS_SPJ_POD",   attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9   },
                { CLSID = "DIS_AKG_DLPOD", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9  },

                { CLSID = "DIS_TANK800",        attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9 }, 
                { CLSID = "DIS_TANK1100",       attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9 },
                { CLSID = "DIS_TANK800_EMPTY",  attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9 },
                { CLSID = "DIS_TANK1100_EMPTY", attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40",arg_value = 0.9 },

                { CLSID = 'DIS_SMOKE_GENERATOR_R', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},
                { CLSID = 'DIS_SMOKE_GENERATOR_G', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},
                { CLSID = 'DIS_SMOKE_GENERATOR_B', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},
                { CLSID = 'DIS_SMOKE_GENERATOR_W', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},
                { CLSID = 'DIS_SMOKE_GENERATOR_Y', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},
                { CLSID = 'DIS_SMOKE_GENERATOR_O', attach_point_position = {0.0, 0.0, 0.0}, arg = 311, connector = "PYLON_40", arg_value = 0.9},

--				=== Remove pylon ===		
				{ CLSID = "<CLEAN>", attach_point_position = {0.0, 0.0, 0.0}, connector = "PYLON_40", arg_value = -1.0 },
            }
        ),
		...
		pylon(5, 1, 0, 0, 0,
            ...
            {
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },

--				=== BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- AIM-120C-7 x1
--              { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 312, connector = "PYLON_51", arg_value = -1.0 }, -- AIM-120C-7 x2
                { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 312, connector = "PYLON_51", arg_value = -1.0 }, -- AIM-120C-7 x3
				
--				=== AIR TO GROUND MISSILES ===
                { CLSID = "DIS_C-701T",       attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- AGM-65K TV
				{ CLSID = "DIS_C-701IR",      attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- AGM-65G IR
                { CLSID = "DIS_CM-400AKG",    attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- TESTING!
                { CLSID = "DIS_C-802AK",      attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- Rb15F Mk4 Antiship missiles
                { CLSID = 'DIS_CM-802AKG',    attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 },	--KEPD 350 
                { CLSID = "DIS_LD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50", arg_value = 1.0 }, -- MAR-1 Anti radiation missiles x1
                { CLSID = "DIS_LD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, arg = 312, connector = "PYLON_50", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x1
--              { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, arg = 312, connector = "PYLON_50", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x2	
        
					
--			    === GUIDED BOMBS ===
                { CLSID = "DIS_GBU_10", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-10

				{ CLSID = "DIS_GBU_12", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-12
				{ CLSID = "DIS_GBU_12_DUAL",attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-12 x 2
--              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-12 x2
                { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-12 x3
                
                { CLSID = "DIS_GBU_16", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- GBU-16
				               
                { CLSID = "DIS_GB6",     attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 },-- AGM154-A
                { CLSID = "DIS_GB6_HE",  attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- AGM154-B
                { CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 },-- AGM154-C		

                { CLSID = "DIS_LS_6_100",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- GBU-31 BLU-109
--              { CLSID = "DIS_LS_6_100_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- WIP
                { CLSID = "DIS_LS_6_100_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_250",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- GBU-39 SDBx2
-- 				{ CLSID = "DIS_LS_6_250_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- GBU-39 SDBx4
                { CLSID = "DIS_LS_6_250_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_500", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- DWS39/BK90	
								
--				=== UNGUIDED BOMBS ===
				{ CLSID = "DIS_MK_20",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-20 Rockeye (can we make this the M71 LD)
--              { CLSID = "DIS_MK_20_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19
                { CLSID = "DIS_MK_20_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19

                { CLSID = "{Mk82SNAKEYE}",              attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82S
--              { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19
                { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19

                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82
--              { CLSID = "{BRU33_2X_MK-82}",                     attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82 x 2
--              { CLSID = "DIS_MK_82_DUAL_GDJ_II19_L",              attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19
                { CLSID = "DIS_MK_82_DUAL_GDJ_II19_R",              attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19

                { CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Mk-83
				
				{ CLSID = "DIS_TYPE200",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- SB M71
--				{ CLSID = "DIS_TYPE200_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- SB M71
				{ CLSID = "DIS_TYPE200_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- SB M71

--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90",                   attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- Brimstone x3
                { CLSID = "DIS_RKT_90_UG",                 attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 }, -- M70B AP
--              { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 },
                { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 },
				
--				=== OTHERS ===   
                { CLSID = "DIS_WMD7",      attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },
                { CLSID = "DIS_SPJ_POD",   attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5  },
                { CLSID = "DIS_AKG_DLPOD", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51", arg_value = 0.5 },

                { CLSID = "DIS_TANK800",        attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51",arg_value = 0.5 }, 
                { CLSID = "DIS_TANK1100",       attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51",arg_value = 0.5 },
                { CLSID = "DIS_TANK800_EMPTY",  attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51",arg_value = 0.5 },
                { CLSID = "DIS_TANK1100_EMPTY", attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_51",arg_value = 0.5 },

                { CLSID = 'DIS_SMOKE_GENERATOR_R', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_G', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_B', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_W', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_Y', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },
                { CLSID = 'DIS_SMOKE_GENERATOR_O', attach_point_position = {0.0, 0.0, 0.0}, arg = 312, connector = "PYLON_50",arg_value = 1.0 },

--				=== Remove pylon ===		
				{ CLSID = "<CLEAN>", attach_point_position = {0.0, 0.0, 0.0}, connector = "PYLON_50", arg_value = -1.0 },            }
        ),
		...
		pylon(6, 1, 0, 0, 0,
            ...
            {
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 },

--				=== BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- AIM-120C-7 x1
--              { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, connector = "point313", arg_value = -1.0 }, -- AIM-120C-7 x2
                { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, connector = "point313", arg_value = -1.0 }, -- AIM-120C-7 x3
...
--				=== AIR TO GROUND MISSILES ===
                ...
                { CLSID = 'DIS_CM-802AKG',    attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 },	--KEPD 350 
                { CLSID = "DIS_LD-10",        attach_point_position = {0.0, 0.0, 0.0}, arg_value = 1.0 }, -- MAR-1 Anti radiation missiles x1
                { CLSID = "DIS_LD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0}, connector = "point313", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x1
--              { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0}, connector = "point313", arg_value = -1.0 }, -- MAR-1 Anti radiation missiles x2	
        
					
--			    === GUIDED BOMBS ===
                { CLSID = "DIS_GBU_10", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-10

				{ CLSID = "DIS_GBU_12", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-12
				{ CLSID = "DIS_GBU_12_DUAL",attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-12 x 2
--              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-12 x2
                { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-12 x3
                
                { CLSID = "DIS_GBU_16", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- GBU-16
				               
                { CLSID = "DIS_GB6",     attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },-- AGM154-A
                { CLSID = "DIS_GB6_HE",  attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- AGM154-B
                { CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },-- AGM154-C		

                { CLSID = "DIS_LS_6_100",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- GBU-31 BLU-109
--               { CLSID = "DIS_LS_6_100_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- WIP
                { CLSID = "DIS_LS_6_100_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_250",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- GBU-39 SDBx2
--				{ CLSID = "DIS_LS_6_250_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- GBU-39 SDBx4
                { CLSID = "DIS_LS_6_250_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },-- WIP

                { CLSID = "DIS_LS_6_500", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- DWS39/BK90	
								
--				=== UNGUIDED BOMBS ===
				{ CLSID = "DIS_MK_20",                 attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-20 Rockeye (can we make this the M71 LD)
--              { CLSID = "DIS_MK_20_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19
                { CLSID = "DIS_MK_20_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-20 Rockeye x2 gjd-ii19

                { CLSID = "{Mk82SNAKEYE}",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82S
--              { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19
                { CLSID = "DIS_MK_82S_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82 Snakeye x2 gjd-ii19

                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82
                --{ CLSID = "{BRU33_2X_MK-82}",                     attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82 x 2
                { CLSID = "DIS_MK_82_DUAL_GDJ_II19_L",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19
--              { CLSID = "DIS_MK_82_DUAL_GDJ_II19_R",              attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-82 x2 gjd-ii19

                { CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Mk-83
				
				{ CLSID = "DIS_TYPE200",        attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- SB M71
				{ CLSID = "DIS_TYPE200_DUAL_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- SB M71
--				{ CLSID = "DIS_TYPE200_DUAL_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- SB M71

--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90",                   attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- Brimstone x3
                { CLSID = "DIS_RKT_90_UG",                 attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 }, -- M70B AP
                { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_L", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
--              { CLSID = "DIS_LAU68_MK5_DUAL_GDJ_II19_R", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
				
--				=== OTHERS ===   
                { CLSID = "DIS_WMD7",      attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },
                { CLSID = "DIS_SPJ_POD",   attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5  },
                { CLSID = "DIS_AKG_DLPOD", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
...
--              { CLSID = "DIS_TANK1100_EMPTY", attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5 },
                ...
                { CLSID = 'DIS_SMOKE_GENERATOR_R', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_G', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_B', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_W', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_Y', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },
                { CLSID = 'DIS_SMOKE_GENERATOR_O', attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = 0.5 },

--				=== Remove pylon ===		
				{ CLSID = "<CLEAN>", attach_point_position = {0.0, 0.0, 0.0}, connector = "point313", arg_value = -1.0 },
		...
		pylon(7, 0, 0, 0, 0,
            ...
            {
--				=== INFRARED AIR TO AIR MISSILES ===
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
                
--              === BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_PL-12", attach_point_position = {0.0, 0.0, 0.0}, arg_increment = 0.0},   -- Meteor x1
                { CLSID = "DIS_SD-10", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 }, -- AIM-120C-7 x1
--              { CLSID = "DIS_SD-10_DUAL_L", attach_point_position = {0.0, 0.23, 0.0},arg = 314, arg_value = -1.0,}, -- AIM-120C-7 x2
--              { CLSID = "DIS_SD-10_DUAL_R", attach_point_position = {0.0, 0.23, 0.0},arg = 314, arg_value = -1.0,}, -- AIM-120C-7 x3
							
--				==== SMOKE PODS ===
                { CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E741}", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E742}", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E743}", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E744}", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E745}", attach_point_position = {0.0, 0.0, 0.0}, arg = 314, arg_value = 1.0 },
