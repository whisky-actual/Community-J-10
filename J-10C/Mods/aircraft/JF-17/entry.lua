...
declare_plugin(self_ID, {
    ...
    infoWaitScreen = _('DCS : J10-C Community MOD'),
})
...
mount_vfs_texture_path (current_mod_path.."/Skins/3/ME")--for simulator loading window
...
--J-10C
dofile(current_mod_path.."/Views.lua")
make_view_settings('J-10C', ViewSettings, SnapViews)
make_flyable('J-10C', current_mod_path .. '/Cockpit/Scripts/', JF17_FM, current_mod_path .. '/Comm/comm.lua')
