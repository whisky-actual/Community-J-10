...
local texts = {
    -- left
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR3_Y, value = "1/OFF", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_qty_list", 0}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR4_Y, value = "2/0.2", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_qty_list", 1}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR5_Y, value = "4/0.5", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_qty_list", 2}},
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR5_Y, value = "6/0.5", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_ag_qty_list", 3}},
    },
}
