...
MFCD_TEX_IND5_WY    = "mfcd_tex_ind5_wy"
...
TV_RENDER.additive_alpha  = false
...
local osb_txt = {
    ...
    {
        name='WMD_SP',    value='SP',            init_pos={MFCD_FONT_UD3_X,    MFCD_FONT_U_Y  }, align='CenterCenter', ctrls={{'POD_wmd_snowplow'},{"POD_wmd_check"},},
    },
    {
        name="WMD_wbhot", value="WHOT",          init_pos={MFCD_FONT_UD4_X,    MFCD_FONT_U_Y  }, align="CenterCenter", ctrls={{"POD_wmd_WBHOT"},{"POD_wmd_check"},},
    },
    {
    ...
    {
        name="WMD_CODE",  value="C\nO\nD\nE",    init_pos={MFCD_FONT_R_HORI_X, MFCD_FONT_LR3_Y}, align="RightCenter",  ctrls={{"POD_wmd_check", 1.0},},
    }, --设置code
    {
        ...
        name="WMD_LSRMAN",value="L\nS\nR",    init_pos={MFCD_FONT_R_HORI_X, MFCD_FONT_LR4_Y}, align="RightCenter",  ctrls={{"POD_wmd_check"},},
    }, --自动/手动照射
    {
        name="WMD_UNCAGE",value="C\nA\nG\nE",    init_pos={MFCD_FONT_L_HORI_X, MFCD_FONT_LR1_Y}, align="LeftCenter",   ctrls={{"POD_wmd_uncage"},{"POD_wmd_check", 1.0},},
    }, --uncage
    
    {
        name='WMD_GAIN',  value="0",     init_pos={MFCD_FONT_L_HORI_X, (MFCD_FONT_LR2_Y + MFCD_FONT_LR3_Y)/2}, align="LeftCenter",
        ctrls={{'POD_wmd_params', 1.0},{"POD_wmd_check"},},
    },
    {
        name='WMD_LEVEL', value="0",     init_pos={MFCD_FONT_L_HORI_X, (MFCD_FONT_LR4_Y + MFCD_FONT_LR5_Y)/2}, align="LeftCenter",
        ctrls={{'POD_wmd_params', 2.0},{"POD_wmd_check"},},
    },
    {
        name='WMD_REFCOS',value="RE\nFOCUS",init_pos={MFCD_FONT_R_HORI_X, MFCD_FONT_LR5_Y}, align="RightCenter",
        ctrls={{'POD_wmd_check_focusing'},{"POD_wmd_check"},},
    },
    --{
...
for i=1, #(osb_txt) do
    ...
    text_strpoly.material           = MFCD_FONT_WY
...
local tex_polys = {
    ...
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={0, 0, 0}, vertices = {{0.25, 0.25}, {0.25, -0.25}, {-0.25, -0.25}, {-0.25, 0.25}},
        tex_coords = MFCD_tex_coord(683, 875, 1356-683, 1548-875, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_TDC"}, {"POD_wmd_check"},},
    }, -- 十字
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={0, 0, 0}, vertices = {{0.005, 0.005}, {0.005, -0.005}, {-0.005, -0.005}, {-0.005, 0.005}},
        tex_coords = MFCD_tex_coord(327, 1141, 333-327, 1147-1141, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_sa_point"},{"POD_wmd_check"},},
    }, -- tdc标
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={-0.25, 0.25, 0}, vertices = {{CS, CS}, {CS, -CS}, {-CS, -CS}, {-CS, CS}}, 
        tex_coords = MFCD_tex_coord(1253, 464, 75, 75, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_check_lock", 1.0,-1.0, CS},{"POD_wmd_check"},},
    }, -- 左上角
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={ 0.25, 0.25, 0}, vertices = {{CS, CS}, {CS, -CS}, {-CS, -CS}, {-CS, CS}},
        tex_coords = MFCD_tex_coord(1553, 464, 75, 75, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_check_lock", 1.0, 1.0, CS},{"POD_wmd_check"},},
    }, -- 右上角
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={-0.25,-0.25, 0}, vertices = {{CS, CS}, {CS, -CS}, {-CS, -CS}, {-CS, CS}},
        tex_coords = MFCD_tex_coord(1253, 764, 75, 75, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_check_lock",-1.0,-1.0, CS},{"POD_wmd_check"},},
    }, -- 左下角
    {
        material = MFCD_TEX_IND5_WY,
        init_pos={ 0.25,-0.25, 0}, vertices = {{CS, CS}, {CS, -CS}, {-CS, -CS}, {-CS, CS}},
        tex_coords = MFCD_tex_coord(1553, 764, 75, 75, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_check_lock",-1.0, 1.0, CS},{"POD_wmd_check"},},
    }, -- 右下角
    ...
    {
        material = MFCD_TEX_IND2_W,
        init_pos={MFCD_BOX3_R_VERT_X,MFCD_FONT_LR4_Y},
        vertices = {{120/2000, 144/176 * 293.333/2000}, {120/2000, -144/176 * 293.333/2000}, {-120/2000, -144/176 * 293.333/2000}, {-120/2000, 144/176 * 293.333/2000}},
        tex_coords = MFCD_tex_coord(0, 1770, 72, 144, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls={{"POD_wmd_LSR_STAT"},{"POD_wmd_check"},},
        --name="WMD_LSRMAN",value="L\nS\nR",    init_pos={MFCD_FONT_R_HORI_X, MFCD_FONT_LR4_Y}, align="RightCenter",  ctrls={{"POD_wmd_LSR_STAT"},{"POD_wmd_check"},},
    }, -- LSR frame
}
local tex_poly
