...
local texts = {
    -- left
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR3_Y, value = "AA 1", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 0}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR4_Y, value = "AA 2", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 1}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR5_Y, value = "AA 3", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 2}},
    },
    
    -- right
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR3_Y, value = "AA 4", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 3}},
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR4_Y, value = "AA 5", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 4}},
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR5_Y, value = "AA 6", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_aa_wpn_list", 5}},
    },
