...
for idx = 0, 1 do
    ...
    oap_line.material        = MFCD_MATERIAL_WHITE
    --[[
...
spi_sym_tex.material        = MFCD_TEX_IND3_BL
spi_sym_tex.init_pos        = {0, FWD_COMP_BIAS, 0}
--spi_sym_tex.tex_coords      = MFCD_tex_coord(888, 0, 148, 148, TEX_SIZE_X, TEX_SIZE_Y)
--spi_sym_tex.tex_coords      = MFCD_tex_coord(  0, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y)
spi_sym_tex.state_tex_coords = {
    MFCD_tex_coord(888,   0, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),
    MFCD_tex_coord(  0, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y), -- 空心三角形: 敌机
    MFCD_tex_coord(592, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y), -- 空心圆形: 友基
    MFCD_tex_coord(888, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y), -- 空心方形: 未识别
}
spi_sym_tex.vertices        = {{ hh, hh}, { hh,-hh}, {-hh,-hh}, {-hh, hh},}
