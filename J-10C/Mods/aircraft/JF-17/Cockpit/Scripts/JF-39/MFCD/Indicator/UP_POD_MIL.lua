...
for i=1, #(osb_txt) do
    ...
    text_strpoly.BackgroundMaterial = MakeMaterial(nil, MFCD_COLOR_DARK)
...
local tex_polys = {
    { -- gain +
        ...
        mat = MFCD_TEX_IND1_W, tex_coords = MFCD_tex_coord(1196, 1596, 68, 68, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls = {{'POD_link_check_video'},},
    },
    { -- gain -
        init_pos={MFCD_BOX3_L_VERT_X, MFCD_FONT_LR5_Y},
        vertices = {{113.333/2000, 113.333/2000}, {113.333/2000, -113.333/2000}, {-113.333/2000, -113.333/2000}, {-113.333/2000, 113.333/2000}},
        mat = MFCD_TEX_IND1_W, tex_coords = MFCD_tex_coord(1196, 1664, 68, 68, TEX_SIZE_X, TEX_SIZE_Y),
        ctrls = {{'POD_link_check_video'},},
    },
    { -- level +
