...
MFCD_TEX_IND4_Y = "mfcd_tex_ind4_y"
MFCD_TEX_IND4_R = "mfcd_tex_ind4_r"
...
texs = {
    ...
    -- OSB state
    {-- iff
        cx = (MFCD_FONT_UD3_X + MFCD_FONT_UD4_X) / 2, cy = MFCD_FONT_U_Y, hw = 116/160 * 266.667/2000, hh = 133.333/2000, ulx =   72, uly = 1770, w = 116, h = 80, mat = MFCD_TEX_IND2, state_tex = true,
        multi_tex = {
