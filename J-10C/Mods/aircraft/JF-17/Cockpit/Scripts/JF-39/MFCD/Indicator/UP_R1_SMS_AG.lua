...
local texts = {
    {-- 
        ...
        ctrls = {{"sms_ag_cntl_label"}, {"mfcd_isedit_show", 0}},
    },
    ...
    {-- Missle Arm State
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR2_Y, value = "MSL STATE", alignment = "RightCenter",
        ctrls = {{"sms_prog_ag_msl_arm"}, {"mfcd_isedit_show", 0}},
    },
...
gun_box.controllers = {{"sms_gun_box"}, {"mfcd_isedit_show", 0}}
AddToUpper(gun_box)
gun_box = nil
