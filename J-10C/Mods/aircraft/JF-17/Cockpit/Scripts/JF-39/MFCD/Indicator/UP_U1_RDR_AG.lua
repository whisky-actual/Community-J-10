...
local texs_local = {
    --[[{-- exp/dbs
        ...
        ctrls = {{"rdr_osb_state_dbs"}},
    },]]
    {-- stby
        cx = MFCD_FONT_UD3_X, cy = MFCD_FONT_U_Y, hw = 138/160 * 266.667/2000, hh = 133.333/2000, ulx = 1816, uly = 1888, w = 138, h = 80,
        mat = MFCD_TEX_IND2, state_tex = true,
        multi_tex = {
            MFCD_tex_coord(1816, 1888, 138,  80, TEX_SIZE_X, TEX_SIZE_Y), -- slash
            MFCD_tex_coord(  72, 1850, 138,  80, TEX_SIZE_X, TEX_SIZE_Y), -- frame
        },
    ...
    {-- frz
        cx = MFCD_BOX3_R_VERT_X, cy = MFCD_FONT_LR3_Y, hw = 120/2000, hh = 240/2000, ulx = 1816, uly = 1808, w = 116, h = 80,
        mat = MFCD_TEX_IND2, state_tex = true,
        multi_tex = {
            MFCD_tex_coord(1744, 1728,  72, 144, TEX_SIZE_X, TEX_SIZE_Y), -- slash
            MFCD_tex_coord(   0, 1770,  72, 144, TEX_SIZE_X, TEX_SIZE_Y), -- frame
        },
        ctrls = {{"rdr_osb_state_frz"}},
    },

    {-- rbm
        cx = MFCD_FONT_UD2_X, cy = MFCD_FONT_U_Y, hw = 138/160 * 266.667/2000, hh = 133.333/2000, ulx = 1816, uly = 1888, w = 138, h = 80,
        mat = MFCD_TEX_IND2,
        ctrls = {{"rdr_osb_state_rbm"}},
    },
    
    {-- 上三角
        cx = MFCD_BOX3_R_VERT_X, cy = MFCD_FONT_LR1_Y, hw = 113.333/2000, hh = 113.333/2000, ulx = 1196, uly = 1596, w = 68, h = 68,
        mat = MFCD_TEX_IND1,
        ctrls = {{"rdr_hide_agr_on"},{"rdr_state_draw"}},
    },
    {-- 下三角
    ...
    {-- bcn intl off
        cx = MFCD_BOX3_R_VERT_X, cy = MFCD_FONT_LR5_Y, hw = 120/2000, hh = 240/2000, ulx = 1744, uly = 1728, w = 72, h = 144,
        mat = MFCD_TEX_IND2,
        ctrls = {{"rdr_bcn_intl_state", 1},{"rdr_hide_agr_on"},{"rdr_state_draw"}},
    },
}
...
local texts_local = {
    ...
    --[[{-- BCN INTL
        cx = MFCD_FONT_L_VERT_X, cy = MFCD_FONT_LR2_Y, value = "I\nN\nT\nL", align = "LeftCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
        ctrls = {{"rdr_bcn_intl_state", 0},{"rdr_hide_agr_on"},{"rdr_state_draw"}},
    },]]
    {-- 雷达当前az范围
    ...
    --[[{-- 雷达当前PRF设置
        ...
        ctrls = {{"rdr_prf_setting"}},
    },]]
    {-- 雷达当前显示距离
        cx = MFCD_FONT_R_HORI_X, cy = (MFCD_FONT_LR1_Y + MFCD_FONT_LR2_Y) / 2, align = "RightCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
        ctrls = {{"rdr_hide_agr_on"},{"rdr_range"}},
    },
    {-- 雷达图像冻结
        cx = MFCD_FONT_R_VERT_X, cy = MFCD_FONT_LR3_Y, value = "F\nR\nZ", align = "RightCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
        ctrls = {{"rdr_state_draw"}},
    },
    {-- 雷达天线俯仰稳定方式
        cx = MFCD_FONT_R_VERT_X, cy = MFCD_FONT_LR4_Y, value = "S\nL\nV", align = "RightCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
        ctrls = {{"rdr_ag_el_stab"}},
    },
    
    
    -- OSB RIGHT
    {-- 速度门限/BCN INTL
        cx = MFCD_FONT_R_VERT_X, cy = MFCD_FONT_LR5_Y, align = "RightCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
        ctrls = {{"rdr_ag_mtl_intl"}},
    },
}
