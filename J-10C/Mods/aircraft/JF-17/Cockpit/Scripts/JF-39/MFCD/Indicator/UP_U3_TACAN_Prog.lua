...
local strs_tcn = {
    ...
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR1_Y, value = "TCN01", alignment = "LeftCenter"
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR2_Y, value = "TCN02", alignment = "LeftCenter"
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR3_Y, value = "TCN03", alignment = "LeftCenter"
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR4_Y, value = "TCN04", alignment = "LeftCenter"
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR5_Y, value = "TCN05", alignment = "LeftCenter"
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR1_Y, value = "TCN06", alignment = "RightCenter"
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR2_Y, value = "TCN07", alignment = "RightCenter"
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR3_Y, value = "TCN08", alignment = "RightCenter"
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR4_Y, value = "TCN09", alignment = "RightCenter"
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR5_Y, value = "TCN10", alignment = "RightCenter"
    },
}
