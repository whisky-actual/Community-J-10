...
local texts = {
    -- left
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR3_Y, value = "LCOS", alignment = "LeftCenter", -- TODO: controller
        --ctrls = {{"sms_aa_gunsight_list", 0}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR4_Y, value = "SSLC", alignment = "LeftCenter", -- TODO: controller
        --ctrls = {{"sms_aa_gunsight_list", 1}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR5_Y, value = "SS", alignment = "LeftCenter", -- TODO: controller
        --ctrls = {{"sms_aa_gunsight_list", 2}},
    },
}
