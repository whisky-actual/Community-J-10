...
texs = {
    ...
    {-- 雷达天线el位置 指示符 T
        ...
        mat = MFCD_TEX_IND4_W, name = "rdr_ag_el_sym",
        ctrls = {{"rdr_hide_agr_on"},{"rdr_atenna_beam_el"}},
    },
    {-- 雷达天线az位置 指示符 T 一直有，因此传递参数0
        ...
        ctrls = {{"rdr_hide_agr_on"},{"rdr_ag_atenna_beam_az"}}, --parent_element = "",
    },
    ...
    {-- 上三角
        ...
        mat = MFCD_TEX_IND1,
        ctrls = {{"rdr_state_draw"},{"mfcd_isedit_show", 0}},
    },
    {-- 下三角
...
lines = {
    {
        init_pos = {0, -740/1000, 0}, ctrls = {{"rdr_ag_antenna_beam_az_limit", -1, 0.8}, {"rdr_declutter_check"}},
        mat = MFCD_LINE_WHITE
    },
    {
        init_pos = {0, -740/1000, 0}, ctrls = {{"rdr_ag_antenna_beam_az_limit",  1, 0.8}, {"rdr_declutter_check"}},
    ...
    {
        init_pos = {0, -740/1000, 0}, ctrls = {{"rdr_ag_antenna_exp_dbs_bearing", 0.15},},
        mat = MFCD_MATERIAL_WHITE, width = 0.006
    },
}

for i=1, #(lines) do
    line_obj                 = CreateElement "ceSimpleLineObject"
    line_obj.material        = nil
...
rdr_beam_el_range.material        = MFCD_MATERIAL_WHITE
...
texts = {
    --[[{-- 雷达el上的扫描俯仰角
        cx = 0.06, cy = 0, mat = MFCD_FONT_W, value = "13", align = "LeftCenter", strdefs = MFCD_STRINGDEFS_DEF_X06,
        ctrls = {{"rdr_hide_agr_on"},{"rdr_el_sym_num"}}, parent = "rdr_ag_el_sym",
    },
    ...
    {-- 雷达当前增益
        ...
        ctrls = {{"rdr_map_gain"},{"mfcd_isedit_show", 0}},
    },
    
    {-- HPT信息
        cx = 725/1000, cy = -560/1000, mat = MFCD_FONT_W, value = "TOAXX:XX\nXX.XNM", align = "RightTop", strdefs = MFCD_STRINGDEFS_DEF_X08, isdraw = false,
        ctrls = {{"rdr_ag_tgt_info"}},
    },
 
    {-- AGR信息
        cx = 0, cy = MFCD_FONT_LR2_Y, mat = MFCD_FONT_W, value = "NO RANGE", align = "CenterCenter", strdefs = MFCD_STRINGDEFS_DEF_X1, isdraw = false,
        ctrls = {{"rdr_ag_agr_info"}},
    },
}
