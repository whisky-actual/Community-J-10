...
for cat = 0, 2 do
    for c = (MAX_DL_CONTACTS-1), 0, -1 do
        ...
        tex_poly.state_tex_coords = {
            ...
            MFCD_tex_coord( 888, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--2 空心方形  : 未识别
            MFCD_tex_coord( 296, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--3 空心标签  : 面目标

            MFCD_tex_coord( 148, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--4 空心三角形+横线: 敌机
            MFCD_tex_coord( 740, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--5 空心圆+横线    : 友机
            MFCD_tex_coord(1036, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--6 空心方形+横线  : 未识别
            MFCD_tex_coord( 444, 148, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--7 空心标签+横线  : 面目标
			
			-- 无航向
            MFCD_tex_coord( 740, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--0 空心三角形: 敌机
            MFCD_tex_coord(1332, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--1 空心圆    : 友机
            MFCD_tex_coord(1628, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--2 空心方形  : 未识别
            MFCD_tex_coord(1036, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--3 空心标签  : 面目标

            MFCD_tex_coord( 888, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--4 空心三角形+横线: 敌机
            MFCD_tex_coord(1480, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--5 空心圆+横线    : 友机
            MFCD_tex_coord(1776, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--6 空心方形+横线  : 未识别
            MFCD_tex_coord(1184, 592, 148, 148, TEX_SIZE_X, TEX_SIZE_Y),--7 空心标签+横线  : 面目标
        }
