...
local texs = {
    {-- 方框
        cx= 0, cy = (MFCD_FONT_LR4_Y + MFCD_FONT_LR5_Y)/2, hw = 996.667/2000, hh = 703.333/2000, ulx = 0, uly = 1500, w = 598, h = 422,
    ...
    --[[{-- <----
        ...
        mat = MFCD_TEX_IND1, tex_sx = TEX_SIZE_X, tex_sy = TEX_SIZE_Y, ctrls = {{"sms_load_pylon_selected", 1}}
    },
    {-- <----
