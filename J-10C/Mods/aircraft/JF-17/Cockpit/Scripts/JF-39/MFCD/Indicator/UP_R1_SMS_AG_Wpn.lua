...
local texts = {
    -- left
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR3_Y, value = "AG 1", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 0}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR4_Y, value = "AG 2", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 1}},
    },
    {
        cx = MFCD_FONT_L_HORI_X, cy = MFCD_FONT_LR5_Y, value = "AG 3", alignment = "LeftCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 2}},
    },
    
    -- right
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR3_Y, value = "AG 4", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 3}},
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR4_Y, value = "AG 5", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 4}},
    },
    {
        cx = MFCD_FONT_R_HORI_X, cy = MFCD_FONT_LR5_Y, value = "AG 6", alignment = "RightCenter", -- TODO: controller
        ctrls = {{"sms_ag_wpn_list", 5}},
    },
