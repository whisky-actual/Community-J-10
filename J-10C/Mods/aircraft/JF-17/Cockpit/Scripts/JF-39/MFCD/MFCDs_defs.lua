...
MFCD_MATERIAL_BLACK1  = "mfcd_mesh_bk1"
MFCD_MATERIAL_BLACK2  = "mfcd_mesh_bk2"
...
MFCD_FONT_D_UY  = -0.96*H2W_SCALE - UP_CY
...
function AddElementObject(object)
    ...
    if (object.use_mipfilter == nil) then
        object.use_mipfilter = true
    end
    if (object.additive_alpha == nil) then
