...
-- JF39_HMD
indicators[#indicators + 6] = {"DEKA_Device::JF_17::ccHUD", script_path .. "/JF-39/HMD/Indicator/HMD_page_init.lua", devices.HMD, {{"CPT-HUD-CENTER"},{sx_l =0.0,sy_l =  0.1,sz_l = 0,sh = 0,sw = 0}}}
