...
local mainGear = {
	...
	amortizer_max_length					= 0.33, --3D Modell
	amortizer_basic_length					= 0.33, --3D Modell
	amortizer_spring_force_factor			= 1800000, --F16 = 2.1e+7, F15 = 990000.0,(reduce_length)
...
JF17_FM = {
center_of_mass		= {0.25, 0.0, 0.0},--x,y,z  // Model has origin at actual COM



moment_of_inertia 	= {  12875.0, 85552.0, 75674.0, -1331.0},--Ix,Iy,Iz,Ixy = Roll, yaw pitch. Values from VSP but maybe too low (esp roll) testing conversion from slug/sqfeet to kg/m2
...
suspension 			= {
	  { -- NOSE WHEEL
			...
			amortizer_min_length						= 0.0,
			amortizer_max_length						= 0.32, -- measure 3d model //Panda
			amortizer_basic_length						= 0.32, -- measure 3d model //Panda
