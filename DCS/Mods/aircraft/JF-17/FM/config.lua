    ...
    suspension = {
        {
			...
			amortizer_max_length						= 0.20,	-- (0.254 (strut stroke) * sin(70 deg)) = 0.239 + 0.0381 (wheel static axle)
			amortizer_basic_length						= 0.20,	-- (0.254 (strut stroke) * sin(70 deg)) = 0.239 + 0.0381 (wheel static axle)
			...
			wheel_radius								= 0.50,	-- 18 / 2 (inch)0.2286
