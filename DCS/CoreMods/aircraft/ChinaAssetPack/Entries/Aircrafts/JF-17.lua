...
JF_17 = {
    ...
    -------------------------
    M_empty                    = 4840,    -- JF-17 with pilot and nose load, kg --6586 --4840
    M_nominal                  = 5090+14500.0,    -- JF-17 kg (Empty Plus Full Internal Fuel) --8339.0
    M_max                      = 5190+4500+6600+14500.0,   -- JF-17 kg (Maximum Take Off Weight)
    M_fuel_max                 = 14500.0,    -- JF-17 kg (Internal Fuel Only)
    ...
    engines_nozzles = {
        [1] = {
            pos                 = {-7.900, 	0.25, 0.000}, -- nozzle coords
