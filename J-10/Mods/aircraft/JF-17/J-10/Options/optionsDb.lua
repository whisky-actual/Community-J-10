...
local tblCptModelList = {
    DbOption.Item(_('Visual Quality')):Value("JF-17-CPT"),
    DbOption.Item(_('Performance')):Value("JF-17-CPT-PERF1"),
}
...
local tblGunSightList = {
    DbOption.Item(_('LCOS')):Value(0),
    DbOption.Item(_('SSLC')):Value(1),
    DbOption.Item(_('SS')):Value(2),
}
local tblGunLimitList = {
    DbOption.Item(_('OFF')):Value(0),
...
return {
    CPLocalList = tblCPLocalList["JF-17-CPT"],
    CPTModel    = DbOption.new():setValue("JF-17-CPT"):combo(tblCptModelList),
