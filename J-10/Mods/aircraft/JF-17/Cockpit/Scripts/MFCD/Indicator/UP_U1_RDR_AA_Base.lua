...
texs = {
    ...
    {-- 雷达天线el位置 指示符 T
        ...
        mat = MFCD_TEX_IND4_W, name = "rdr_aa_el_sym",
    ...
    {-- 雷达天线az位置 指示符 T 一直有，因此传递参数0
        ...
        mat = MFCD_TEX_IND4_W, name = "rdr_aa_az_sym",
    ...
    {-- pip dot
        ...
        mat = MFCD_TEX_IND3_W, ctrls = {{"rdr_aa_pip_dot"}},
    },
...
texts = {
    ...
    {-- 雷达TDC上的扫描高度范围
        cx = 0.06, cy = 0, mat = MFCD_FONT_W, value = "25\n\n\n13", align = "LeftCenter", strdefs = MFCD_STRINGDEFS_DEF_X075,
    ...
    {-- HPT到TDC的方位距离
        cx = -665/1000, cy = -560/1000, mat = MFCD_FONT_W, value = "3.5 259.9D", align = "LeftCenter", strdefs = MFCD_STRINGDEFS_DEF_X08,
...
rdr_ase_circle.material    = MFCD_MATERIAL_WHITE
